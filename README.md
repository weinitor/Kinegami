...
# User Guide:
Run scripts Kinegami_******.m and change parameters if desired. Please install the add-on Optimization Toolbox.
...
For more comprehensive understanding, reference supporting functions.The algorithm requires "fSolve" from the MatLab Optimization Toolbox.
