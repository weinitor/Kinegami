...
if strcmp(jointselect, 'selfassign') == 1
    ...
    hip_to_hip = 2.5*l1;
    first_waypoint = 0.09;
    second_waypoint = hip_to_hip + 0.014 +0.035;
%     first_waypoint = hip_to_hip/3;
    ...
    TransformStruct(2).Oc = [1, 0, 0, l2; ...
                             0, 1, 0, 0; ...
                             0, 0, 1, 0];
                         
    TransformStruct(3).Oc = [cos(-2*pi/3), -sin(-2*pi/3), 0, l2 + l2*cos(-pi/3); ...
                             sin(-2*pi/3), cos(-2*pi/3), 0, l2*sin(-pi/3); ...
                             0, 0, 1, 0];  
                     
    TransformStruct(4).Oc = [cos(-2*pi/3), -sin(-2*pi/3), 0, l2 + l2*cos(-pi/3) - first_waypoint*cos(pi/3); ...
                             sin(-2*pi/3), cos(-2*pi/3), 0, l2*sin(-pi/3) - first_waypoint*sin(pi/3); ...
                             0, 0, 1, -indent];   
                         
    TransformStruct(5).Oc = [cos(-2*pi/3), -sin(-2*pi/3), 0, l2 + l2*cos(-pi/3) - second_waypoint*cos(pi/3); ...
                             sin(-2*pi/3), cos(-2*pi/3), 0, l2*sin(-pi/3) - second_waypoint*sin(pi/3); ...
                             0, 0, 1, -indent];   
                         
    TransformStruct(6).Oc = [cos(pi/3), -sin(pi/3), 0, l2 + (l2*cos(-pi/3)) - hip_to_hip*cos(pi/3); ...
                             sin(pi/3), cos(pi/3), 0, (l2*sin(-pi/3)) - hip_to_hip*sin(pi/3); ...
                             0, 0, 1, 0];                        
                                               
    TransformStruct(7).Oc = [-1, 0, 0, l2 + (l2*cos(-pi/3)) - hip_to_hip*cos(pi/3) + (l2*cos(2*pi/3)); ...
                             0, -1, 0, (l2*sin(-pi/3)) - hip_to_hip*sin(pi/3) + (l2*sin(2*pi/3)); ...
                             0, 0, 1, 0];  

    TransformStruct(8).Oc = [-1, 0, 0, l2 + (l2*cos(-pi/3)) - hip_to_hip*cos(pi/3) + (l2*cos(2*pi/3)) - l1; ...
                             0, -1, 0, (l2*sin(-pi/3)) - hip_to_hip*sin(pi/3) + (l2*sin(2*pi/3)); ...
                             0, 0, 1, 0];                           
